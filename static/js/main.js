...
$(function () {
    ...
    // progressbars
    var drr = $('.art-cirkle-progress')
    var dgr = $('.lang_degree')
    var leng = drr.length

    for (let j = 0; j < leng; j++) {
        var bar = new ProgressBar.Circle(drr[j], {
            strokeWidth: 7,
            easing: 'easeInOut',
            duration: 1400,
            delay: 2500,
        ...
        bar.animate(parseFloat(dgr[j].textContent));
    }
    ...
    for (let i = 0; i < len; i++) {
        var bar = new ProgressBar.Line(abb[i], {
            strokeWidth: 1.72,
            easing: 'easeInOut',
            duration: 1400,
            delay: 2800,
        ...
        bar.animate(parseFloat(deg[i].textContent));
    }
    ...
    $('.current-menu-item a').clone().appendTo('.art-current-page'); //@TODO .current-menu-item
    ...
    document.addEventListener("swup:contentReplaced", function () {
        ...
        $('.current-menu-item a').clone().prependTo('.art-current-page');//@TODO .current-menu-item
...
//     $(this).clone().prependTo('.art-current-page a')
// })
